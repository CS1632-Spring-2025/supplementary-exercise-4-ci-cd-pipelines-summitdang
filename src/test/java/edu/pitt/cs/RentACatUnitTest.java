...
public class RentACatUnitTest {
	...
	public void testListCatsNumCats3() {
		...
		r.addCat(c3);
		String test = r.listCats();
		assertEquals("ID 1. Jennyanydots" + newline + "ID 2. Old Deuteronomy" + newline + "ID 3. Mistoffelees" + newline, test);
	}
